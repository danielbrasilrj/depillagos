package br.com.depillagos.config;
...
@Configuration
@EnableMongoRepositories("br.com.depillagos.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory) throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("br.com.depillagos.config.dbmigrations");
