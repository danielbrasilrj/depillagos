...
Qualquer pessoa pode enviar estes comandos ao número do WhatsApp:

| Comando | Ação |
|---------|------|
| `[libera]` | Desbloqueia o agente com IA para voltar a atender aquele contato |
| `[limpa]` | Limpa a memória do agente para o contato em questão |
| `[atualiza]` | Atualiza a base de conhecimento puxando dados (serviços, produtos...) do Trinks |
...
- **Questionário completo (HTML):** `whatsapp_ia/questionario_ia_whatsapp.html`
- **Questionário completo (PDF):** `whatsapp_ia/questionario_ia_whatsapp_depillagos.pdf`
...
2. **Via documento:** Editar `whatsapp_ia/questionario_ia_whatsapp.html`, regenerar PDF e enviar à empresa de IA
